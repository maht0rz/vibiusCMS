{{$extends_rpdev/admin/layouts/basic}}
  ...
  {{$section_sidebar}}
    ...
    <li class="hassub active"><a href="{{$url}}admin/dashboard/pages"><span class="fa fa-file-o faicon"></span>Pages</a></li>
...
{{$sectionEnd_file}}
  ...
  {{$section_javascript}}
    ...
    $('#pagename').val('');
    function getPages(){
      $.get("{{$url}}admin/ajax/getPages",function(data,status){
           json = jQuery.parseJSON(data);
           $('#fileTree').html('');
           $('#fileTree').append(
             '<li><a id="add-new" href="#"><span class="fa fa-plus faicon"></span><span class="mtext">Add new page</span></a></li>'
           );
        ...
        $('.folder-pages').on('live click', function(){
            ...
            $.get("{{$url}}admin/ajax/getfilePages/"+file,function(data,status){
              console.log(data);
              json = jQuery.parseJSON(data);
        ...
        getPages();
          ...
          $('#save').click(function(){
              ...
              $('#curfile').text(current_file);
               $.post("{{$url}}admin/ajax/updatePage",
                {
                  code:code,
                  file:current_file,
                  old_file:old_file,
          ...
          $('#delete').click(function(){
              ...
              $('#curfile').text(current_file);
               $.post("{{$url}}admin/ajax/deletePage",
                {
                  code:code,
                  file:current_file,
                  old_file:old_file,
